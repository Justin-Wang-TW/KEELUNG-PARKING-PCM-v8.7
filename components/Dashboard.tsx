      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
           ...
           <div className="space-y-3">
                    ...
                    <div key={task.uid} className="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-100 hover:bg-red-100 transition-colors">
                      <div>
                          <div className="flex items-center gap-2">
                            <span className="text-[10px] font-bold text-red-600 bg-white border border-red-200 px-1.5 rounded">{task.stationName}</span>
             ...
             {(tasks || []).filter(t => t.status === TaskStatus.OVERDUE || (t.status !== TaskStatus.COMPLETED && isTaskOverdue(t.deadline))).length === 0 && (
